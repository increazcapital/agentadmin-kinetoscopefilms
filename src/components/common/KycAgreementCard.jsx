        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
          ...
          <div>
            ...
            <p style={{ margin: '3px 0 0', fontSize: '0.82rem', color: '#047857', lineHeight: 1.45 }}>
              Your signed agent agreement and KYC documents have been successfully verified by Super Admin. You can view or download your official contract anytime in your <strong>My Profile</strong> page.
            </p>
          </div>
        </div>
        <button
