...
export default function Login() {
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    try {
      ...
      addToast('Account created successfully! Welcome to YieldIQ Partner Dashboard.', 'success', 'Account Created');
      window.location.href = '/dashboard';
    } catch (err) {
      console.error(err);
  ...
  const syncLocalAgent = (backendCode) => {
    ...
    const rawAgentCode = backendCode || `YLDIQ-AG-${1000 + nextId}`;
            ...
            <div className="animate-fade-in">
              ...
              <form className="kfpl-login-form" onSubmit={handleRegisterSubmit}>
                <div className="kfpl-login-register-scroll">
                  ...
                  <div className="kfpl-login-input-group">
                    <label className="kfpl-login-label">Residential Address</label>
                    <input type="text" name="address" className="kfpl-login-input" placeholder="Enter your residential address" value={regForm.address} onChange={handleRegisterChange} />
                  </div>
                  <div className="kfpl-login-form-row">
                    <div className="kfpl-login-input-group">
